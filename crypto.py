...
dh_group15 = dh.DHParameterNumbers(
...
def dh_private_secret() -> int:
    return base.random_nat(20)

def dh_message(params: dh.DHParameterNumbers, secret: int) -> bytes:
    # FIXME: hackish
    return bytes(str(pow(params.g, secret, params.p)), encoding='ascii')

def dh_shared_secret(params: dh.DHParameterNumbers, secret: int, othermsg: bytes) -> bytes:
    # FIXME: hackish
    return pow(int(othermsg), secret, params.p)
