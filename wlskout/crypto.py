...
dh_group16 = (dh.DHParameterNumbers(
...
dh_group17 = (dh.DHParameterNumbers(
...
dh_group18 = (dh.DHParameterNumbers(
...
def dh_private_secret(params: dh.DHParameterNumbers) -> dh.DHPublicNumbers:
    """
